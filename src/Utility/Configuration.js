...
import Detectizr from "./Utility/Detectizr";
...
export const IS_DESKTOP = (Detectizr.device.type === 'desktop');

export const IS_TABLET = (Detectizr.device.type === 'tablet');

export const IS_MOBILE = (Detectizr.device.type === 'mobile');
